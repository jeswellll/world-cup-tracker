...
def seed_database(db: Session = Depends(database.get_db)):
    ...
    knockouts = [
        ...
        {'id': 76, 'next_match_id': 89, 'is_next_match_home': False, 'stage': 'LAST_32', 'date': '2026-06-29T17:00:00.000Z', 'venue': 'Houston'},
        {'id': 77, 'next_match_id': 91, 'is_next_match_home': True, 'stage': 'LAST_32', 'date': '2026-06-30T21:00:00.000Z', 'venue': 'New York/New Jersey (East Rutherford)'},
